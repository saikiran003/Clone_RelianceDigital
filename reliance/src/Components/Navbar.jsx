      ...
      <div className="navbar">
        ...
        <div>
          ...
          <div className="dropDown3">
            ...
            <div className="first">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Internet Connectivity Devices</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Toners & Ink Cartridges</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Data Storage Devices</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
        ...
        <div>
          ...
          <div className="dropDown4">
            <div className="first">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Point & Shoot Cameras</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Action Cameras</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Photo Storage Devices</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <p>Memory Cards</p>
              </Link>
            ...
            <div className="first">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Digital Camera Accessories</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
        ...
        <div>
          ...
          <div className="dropDown5">
            <div className="first">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Fruits and Vegetable Cleaner</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Oven Toaster Grillers(OTG)</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Cookwares</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Juice Mixer Grinders</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <p>Juicers</p>
              </Link>
            ...
            <div className="first">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Food Processors</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Blenders</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Kitchen Hobs & Gas Stoves</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Popup Toasters</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Coffee Makers & Grinders</h4>
              </Link>
            </div>
            <div className="first">
              <Link to="/smartphones" className="productsName">
                <h4>Reconnect Disney|Marvel Kitchen Collection</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Air Fryers</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Speciality Appliances</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Electric Kettles</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
        ...
        <div>
          ...
          <div className="dropDown6">
            <div className="first">
              <Link to="/smartphones" className="productsName">
                <h4>Shavers & Trimmers</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Epilators</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Hair Dryers & Stylers</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
            ...
            <div className="first">
              <Link to="/smartphones" className="productsName">
                <h4>Reconnect Disney|Marvel Grooming Collection</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Hygiene & Personal Care</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
        ...
        <div>
          ...
          <div className="dropDown7">
            <div className="first">
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Batteries & PowerBanks</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Cables & Cords</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Chargers & Adapters</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Bluetooth & WiFi Speakers</h4>
              </Link>
            ...
            <div className="first">
              <Link to="/smartphones" className="productsName">
                <h4>Reconnect Disney|Marvel Accessories</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Memory Cards</h4>
              </Link>
              ...
              <Link to="/smartphones" className="productsName">
                <h4>Screen Guards & Protectors</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Power Strips & Extension Cords</h4>
              </Link>
              <Link to="/smartphones" className="productsName">
                <h4>Stabilizers</h4>
              </Link>
